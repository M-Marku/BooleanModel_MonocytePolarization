...
```{r}
mono_rules <- loadNetwork("rules_modified.txt")
...
plot(m, breaks = NULL, col = hcl.colors(20, palette = "PRGn"), border = NA, key = list(side = 4, cex.axis = 0.75), main = "Jaccard-Needham distance matrix", las = 2)
```
...
colnames(matrica) <- cn
rownames(matrica) <- rn
h <- pheatmap(matrica, border = NA, col = hcl.colors(20, palette = "PRGn"), cutree_rows = 3, show_colnames = T,show_rownames = F, fontsize = 3, las = 2)
```
...
plot(as.matrix(Clust1[3:length(mono_rules$genes)]), main = "Cluster 1", xlab = "Genes", ylab = "Attractors", cex.axis = 0.5, cex.main = 0.75, cex.lab = 0.75, las = 2)
Clust2 <- Clust_frame_attr %>% filter(Cluster == 2)
plot(as.matrix(Clust2[3:length(mono_rules$genes)]), main = "Cluster 2", xlab = "Genes", ylab = "Attractors", cex.axis = 0.5, cex.main = 0.75, cex.lab = 0.75, las = 2)
Clust3 <- Clust_frame_attr %>% filter(Cluster == 3)
plot(as.matrix(Clust3[3:length(mono_rules$genes)]), main = "Cluster 3", xlab = "Genes", ylab = "Attractors", cex.axis = 0.5, cex.main = 0.75, cex.lab = 0.75, las = 2)
Clust4 <- Clust_frame_attr %>% filter(Cluster == 4)
plot(as.matrix(Clust4[3:length(mono_rules$genes)]), main = "Cluster 4", xlab = "Genes", ylab = "Attractors", cex.axis = 0.5, cex.main = 0.75, cex.lab = 0.75, las = 2)
```
